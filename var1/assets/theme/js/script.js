                ...
                e.on("scroll resize", function () {
                    ...
                    a.each(d, function () {
                        var d = a(this),
                            ...
                            h = f.offsetHeight;
                        f = c(f);
                        if ((f + h >= e && f - 50 <= g || b(d)) && d.hasClass("hidden")) d.removeClass("hidden").addClass("animate__fadeInUp animate__delay-1s").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
...
! function () {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.innerHTML = '<a href="https://mobirise.in">mobirise.com</a> Mobirise v5.3.10';
