<script>
export default {
  name: "CardBlockCircularProgressBar",
	props:{
		item: {
			type: Object,
			default() {
...
<template>
      <div class="box" :key="item.text">
        <div class="shadow"></div>
        <div class="content">
          <div class="percent" :data-text="item.text" :style="'--num:'+item.value">
            <div class="dot"></div>
            <svg>
              <circle cx="70" cy="70" r="70"></circle>
              <circle cx="70" cy="70" r="70"></circle>
            </svg>
            <div class="number"><h2>{{item.value}}<span>%</span></h2></div>
          </div>
        </div>
      </div>
