...
<template>
  <section>
    <div class="title-container">
      <svg width="250" height="100" stroke="#ee4b2b" stroke-width="2" class="text-line">
        <text x="0" y="75" fill="none" font-size="100">Error</text>
      </svg>
    </div>

    <div class="container">
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="480" height="300"
        viewBox="0 0 480 300">
        <defs>
          <path class="burger-container" id="prefix__a"
        ...
        <g fill="none" fill-rule="evenodd">
          ...
          <g transform="translate(-448 -157) translate(448 157)">
            ...
            <use fill="#ffd1dc" xlink:href="#prefix__a" />
            <path fill="#778899" fill-rule="nonzero" d="M-14.199 211.2H481.36V301.2H-14.199z"
              mask="url(#prefix__b)" />
            <g class="paes">
            ...
            <g fill-rule="nonzero" stroke="#cc5500" stroke-linecap="round" stroke-width="1.8"
              class="left-sparks">
            ...
            <path fill="#e34234" class="text-path" fill-rule="nonzero" stroke="#e34234" stroke-width="2"
...
<style scoped>
  section{
    ...
    background-color:
      #233329;
    background-image: radial-gradient(#233329, #63d471);
  }
  .title-container {
    position: absolute;
    top: 15%;
  ...
  .text-line text {
    ...
    animation: drawTitleAnim 5s linear infinite, fillTitleAnim 5s ease-in-out infinite;
  }

  @keyframes drawTitleAnim {
    to {
      stroke-dashoffset: 0;
    }
  }

  @keyframes fillTitleAnim {
    from {
      fill:
        #ee4b2b;
      fill-opacity: 0;
  ...
  .burger-container {
    animation: burgerBgAnim 2s alternate infinite;
    transform-origin: center;
  }

  @keyframes burgerBgAnim {
    from {
      transform: scale(0.9);
    }
  ...
  .burger-top {
    animation: rotateBurger 7s 1s cubic-bezier(0.1, 0.5, 0.25, 1) infinite;
    transform-origin: center;
  }

  .burger-bottom {
    animation: rotateBurger 14s cubic-bezier(0.1, 0.5, 0.25, 1) infinite;
    transform-origin: center;
  }
  ...
  .burger-eyes {
    animation: burgerEyesAnim 2s alternate infinite;
    transform-origin: center;
  }

  @keyframes burgerEyesAnim {
    from {
  ...
  .left-sparks, .right-sparks {
    animation: sparking 4s alternate infinite;
  }
  ...
  .text-path {
    ...
    animation: textPathAnim 5s alternate infinite;
  }

  @keyframes textPathAnim {
    0%, 25% {
      fill:
        #e34234;
      stroke-dashoffset: 0;
